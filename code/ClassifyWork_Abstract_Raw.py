...
if os.path.exists(os.path.join('..','result_alltime','Dict_ClassifyWork_Abstract_Raw')):
    ClassifyWork_Abstract_Raw=pickle.load(open(os.path.join('..','result_alltime','Dict_ClassifyWork_Abstract_Raw'),'rb'))
else:
...
for chunk in tqdm(works):
    ...
    chunk_count+=1
    if chunk_count%50==0:
        pickle.dump(ClassifyWork_Abstract_Raw,open(os.path.join('..','result_alltime','Dict_ClassifyWork_Abstract_Raw'),'wb'))
