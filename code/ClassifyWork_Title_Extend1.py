...
if os.path.exists(os.path.join('..','result_alltime','Dict_ClassifyWork_Title_Extend1')):
    ClassifyWork_Title_Extend1=pickle.load(open(os.path.join('..','result_alltime','Dict_ClassifyWork_Title_Extend1'),'rb'))
else:
...
for chunk in tqdm(works):
    ...
    chunk_count+=1
    if chunk_count%50==0:
        pickle.dump(ClassifyWork_Title_Extend1,open(os.path.join('..','result_alltime','Dict_ClassifyWork_Title_Extend1'),'wb'))
