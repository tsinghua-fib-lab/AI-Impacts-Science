...
for target_field_name in target_fields:
    phrase_field_year[target_field_name]=dict()
    for year in range(start_year,end_year+1):
        phrase_field_year[target_field_name][year]=[0,0,dict(),dict()]#number of non-AI papers,number of AI papers,non-AI count abstract,AI count abstract
    ...
    for _,line in chunk.iterrows():
        ...
        for field_id in field_ids:
            ...
            if field_name in target_fields:
                temp=phrase_field_year[field_name][year]
...
with open(os.path.join('..','result_alltime',f'Dict_Work_PhraseLen{phrase_len}ByYear'),'wb') as f:
